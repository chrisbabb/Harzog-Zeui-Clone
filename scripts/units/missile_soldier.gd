extends UnitBase
class_name MissileSoldier
## MissileSoldier - Anti-air ground unit
##
...
func _ready() -> void:
	super._ready()
	unit_name = "Missile Soldier"
	unit_type = "missile_soldier"
	max_health = 80.0
...
## Missile soldiers can ONLY attack flying units
...
func _choose_strategic_target() -> Vector2:
	...
	if not enemy_bases.is_empty():
		...
		if nearest_base:
			...
			return nearest_base.global_position - direction * 200.0
